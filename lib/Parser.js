...
Parser.prototype = {
    ...
    _parseRootRule: function (offset) {
        ...
        return this._actions
            ...
            .then(function (actionsResult) {
                return this._parseScope(rule, offset, actionsResult)
            }, this)
    ...
    _processRule: function (rule) {
        ...
        return this._actions
            .performForRule(rule, this._getSelector())
            .then(function (actionsResult) {
                return this._parseScope(rule, 0, actionsResult)
            }, this)
            .then(function (results) {
                this._popScope();
                return results;
     ...
     * @private
     */
    _parseScope: function (rule, offset, actionsResult) {
        switch (this._getRuleType(rule)) {
            ...
            case this.TYPES.SIMPLE:
                return this._parseSimpleRule(rule, actionsResult);
        }
    },
     ...
     * @private
     */
    _parseSimpleRule: function (rule, actionsResult) {
        if (rule.useActionsResult) {
            debug('._parseSimpleRule() uses action results for %s', rule.name);
