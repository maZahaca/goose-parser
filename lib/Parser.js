            ...
            .then(function (pagination) {
                ...
                return this._env
                    ...
                    .then(function (pageResults) {
                        ...
                        if (
                            this._paginator.getMaxResultsCount() !== Infinity &&
                            results.length > this._paginator.getMaxResultsCount() - 1
                        ) {
                            results = results.slice(0, this._paginator.getMaxResultsCount() - 1);
                            return vow.resolve(results);
                        }
