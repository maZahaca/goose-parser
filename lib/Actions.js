...
Actions.prototype = {
    ...
    performForRule: function (rule, parentSelector) {
        ...
        return this.performActions(actions, parentSelector, rule);
    },
     ...
     * @returns {Promise}
     */
    performActions: function (actions, parentSelector, rule) {
        ...
        return actions.reduce(function (promise, action) {
            ...
            return promise
                .then(self._performAction.bind(self, action, parentSelector, rule))
     ...
     * @private
     */
    _performAction: function (action, parentSelector, rule) {
        ...
        switch (action.type) {
            ...
            case this.TYPES.CONDITION:
                actionPromise = this.performConditionalActions(selector, action.conditions, action.actions, rule);
                break;
            ...
            default:
                ...
                actionPromise = customAction.call(this, action, selector, rule);
                break;
        }
    ...
    wait: function (evalFunction, checkerFunction, args, timeout, interval) {
        ...
        interval = interval || 0;
        checkerFunction = checkerFunction || function(result){return !!result;};
     ...
     * @returns {Promise}
     */
    performConditionalActions: function (selector, conditions, actions, rule) {
        return this
            .performActions(conditions, selector, rule)
            .then(function (result) {
                if (!result) {
                ...
                return this.performActions(actions, selector, rule);
            }, this)
    },
